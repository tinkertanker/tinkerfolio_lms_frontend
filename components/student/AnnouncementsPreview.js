      ...
      <div className="h-full flex flex-col justify-between flex-start">
        <div>
          <div className="flex items-center gap-3 ml-1 sm:ml-0">
            ...
            <h1 className="text-xl font-semibold bg-white rounded-2xl text-gray-600">
              Announcements
            </h1>
          </div>

          {announcements.length > 0 ? (
            announcements.slice(-2).map((announcement, i) => {
        ...
        <button
          className="mt-3 text-sm font-medium text-blue-600 hover:underline focus:outline-none float-right whitespace-nowrap text-right"
    ...
    >
      {(close) => (
        <div className="px-6 py-4 bg-white rounded-lg shadow-lg mx-16 lg:mx-28">
          ...
          <CustomLinkify>
            <p className="my-4">{announcement.description}</p>
          </CustomLinkify>
          <div className="w-full h-0.5 bg-gray-200"></div>
          <div className="flex justify-end">
            <button
              ...
              className="focus:outline-none mt-4 ml-2 px-3 py-1 w-min bg-blue-500 text-white rounded hover:bg-blue-600 font-bold"
            >
              Close
            </button>
          </div>
