    ...
    return (
        <div className="flex flex-col">
            ...
            {tasks.filter((t) => t.status !== 1).length > 0 && (
                <h1 className="text-2xl font-semibold mb-6 mt-12 ml-2">
                    Archived
                </h1>
            )}
                ...
                <div className="pt-3 pb-2 px-2 border-b-2 border-gray-300 cursor-pointer hover:bg-gray-200">
                    <div className="flex flex-row items-center">
                        ...
                        <p
                            ...
                            } py-0.5 px-1 text-sm text-white rounded`}
                        >
        ...
        >
            {(close) => (
                <div className="px-4 py-4 bg-white rounded-lg shadow-lg popup">
                    <h1 className="my-2 mx-2 text-2xl font-bold">
                        {task.name}
                    </h1>
    ...
    return (
        <div className="w-full">
            ...
            <form onSubmit={(e) => submitForm(e)}>
                ...
                <button
                    type="submit"
                    className="mt-4 px-2 py-1 bg-green-600 hover:bg-green-700 text-white rounded"
                >
                    Submit
                </button>
            </form>
