                ...
                >
                  ...
                  <div className="mt-1 flex flex-col">
                    {resource.resources.slice(-3).map((file, _) => (
                      <p
                        className="text-sm text-medium my-0.5 text-gray-600 hover:text-blue-700 cursor-pointer truncate"
                        onClick={() =>
                          reloadResource(file.id, file, resource, i)
                        }
                      >
                        {file.name}
                      </p>
                    ...
                    {resource.resources.length > 3 ? (
                      <p className="text-sm mt-2 text-gray-500 italic">
                        ...({resource.resources.length - 3}) more{" "}
                        {resource.resources.length - 3 > 1 ? "files" : "file"}
                      </p>
                    ) : (
                      <div></div>
                    )}
