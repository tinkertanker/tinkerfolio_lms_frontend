    ...
    return (
        <>
            <div className="flex items-center gap-3 pb-2">
                ...
                <h1 className="text-2xl font-semibold bg-white rounded-2xl">Resources</h1>
            </div>
                    ...
                    <>
                        {resource.section && (
                            <div
                                ...
                                key={i}
                            >
                                <h3 className="font-semibold text-lg text-blue-600 truncate">{resource.section.name}</h3>
