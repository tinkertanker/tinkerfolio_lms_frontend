...
const Classroom = () => {
        ...
        if (!classrooms) {
            ...
            getAccessToken().then((accessToken) => {
                axios
                    ...
                    .then((res) => {
                        setClassroom(
                            res.data.filter((cr) => cr.code === code)[0]
                        );
    ...
    const handleMessage = (msg) => {
        ...
        if (Object.keys(msg)[0] === "submission") {
            ...
            setNames([
                ...names.filter(
                    (name) => name.index !== msg.student_profile.index
                ),
                msg.student_profile,
            ]);
            let newClassroom = {
        ...
        <Popup
            trigger={
                <div className="mt-4 sm:mt-10 ml-2 text-lg rounded-lg">
                    <div>
                        <p className="text-base text-center font-bold text-gray-500">
                            For Students
                        </p>
                    </div>
                    <div>
