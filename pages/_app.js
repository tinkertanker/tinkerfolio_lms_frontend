...
const Layout = ({ children }) => {
    ...
    if (router.pathname === "/")
        navStyle =
            "max-w-4xl 2xl:max-w-6xl mx-auto py-6 px-6 sm:px-0 bg-purple-50 flex flex-row items-center";
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    property="og:image"
                    content="https://www.echoclass.com/logo.png"
                />
            ...
            <div
                className={
                    router.pathname === "/" ? "bg-purple-50" : "bg-gray-100"
                }
            >
                <nav className={navStyle}>
                    {["/", "/login", "join"].includes(router.pathname) ? (
                        ...
                        <div>
                            <h1 className="text-2xl font-logo text-blue-700">
                                EchoClass
                            </h1>
                        </div>
                    )}
                    ...
                    {!auth.isAuthenticated && (
                        <div className="flex flex-row-reverse items-center ml-auto gap-4 sm:gap-8">
                            <Link href="/login">
                                <a className="px-4 py-0.5 border-2 border-blue-500 hover:border-blue-700 text-blue-500 hover:text-blue-700 text-lg rounded font-semibold">
                                    Login
                                </a>
                            </Link>
                            <Link href="/join">
