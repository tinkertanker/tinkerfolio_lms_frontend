...
const Layout = ({children}) => {
    ...
    if (router.pathname === "/") navStyle = "max-w-5xl 2xl:max-w-7xl mx-auto py-6 px-6 md:px-0 bg-purple-50 flex flex-row items-center"
    ...
    return (
      <>
        ...
        <div
          className={router.pathname === "/" ? "bg-purple-50" : "bg-gray-100"}
        >
