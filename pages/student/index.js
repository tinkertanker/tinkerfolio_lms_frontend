        ...
        <div>
            ...
            <main className="flex sm:flex-row flex-col min-h-screen">
                <div className="mt-8 ml-4 mr-2 min-w">
                    ...
                    <button
                        className={`${
                            isTasks ? "bg-gray-300" : "hover:bg-gray-200"
                        } focus:outline-none text-lg font-semibold px-2 py-1 mt-1 w-full text-left rounded-lg`}
                        onClick={() => setIsTasks(!isTasks)}
                    >
                        Tasks
                    </button>
                    <button
                        className={`${
                            !isTasks ? "bg-gray-300" : "hover:bg-gray-200"
                        } focus:outline-none text-lg font-semibold px-2 py-1 my-1 w-full text-left rounded-lg`}
                        onClick={() => setIsTasks(!isTasks)}
                    >
                        Leaderboard
                    </button>
