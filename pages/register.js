...
const Register = () => {
	...
	if (userType === "teacher" && !teacherPassword) {
      setFormError("Please provide a password for teacher registration.");
      return;
    }
    ...
    <div className="bg-gray-100 min-h-screen">
      <Head>
        <title>Registration | Tinkerfolio</title>
        <link
          rel="stylesheet"
